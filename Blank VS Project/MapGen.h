void setStyle()
{
	tilemap = townmap; //Fail-safe incase autism
...
void generateMap()
{
	if (mapStyle == STYLE_TOWN) { //Fail-safe incase autism
	...
	//Janky-ass Autism (trust me)
	spawnExitPortal = false; //Autism-prevention
